...
student_id = 2578028
d2 = student_id % 10 #last digit of student ID
d1 = (student_id // 10) % 10 #second-last digit of student ID
k = (d1 + d2) % 4 + 2
shift = d1 - d2
n_points = 20 + d1
frame_step = d2 + 1
...
plt.ylabel("Y")
plt.show()
# Helps us understand how the data is distributed
# shows how often values occur and how spread out they are
